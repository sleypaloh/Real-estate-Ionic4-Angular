...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(afAuth, alertCtrl, router, afstote) {
        this.afAuth = afAuth;
        this.alertCtrl = alertCtrl;
        this.router = router;
        this.afstote = afstote;
        this.username = "";
        this.password = "";
        this.cpassword = "";
    }
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (password != cpassword) {
                            ...
                            return [2 /*return*/, console.error('Passwords do not match')];
                        }
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.afAuth.auth.createUserWithEmailAndPassword(username + '@gmail.com', password)];
                    case 2:
                        res = _b.sent();
                        if (res) {
                    ...
                    case 3:
                        err_1 = _b.sent();
                        this.showAlert("Fail!", err_1.message);
                        console.dir(err_1);
                        return [3 /*break*/, 4];
    ...
    RegisterPage.prototype.alertPresent = function (header, message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
